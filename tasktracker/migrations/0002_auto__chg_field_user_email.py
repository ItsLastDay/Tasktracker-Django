...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'tasktracker_user', 'email', self.gf('django.db.models.fields.EmailField')(max_length=40))

    def backwards(self, orm):

        # Changing field 'User.email'
        db.alter_column(u'tasktracker_user', 'email', self.gf('django.db.models.fields.CharField')(max_length=40))
