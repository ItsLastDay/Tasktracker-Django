...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Task.expiration_date'
        db.alter_column(u'tasktracker_task', 'expiration_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Task.expiration_date'
        db.alter_column(u'tasktracker_task', 'expiration_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 4, 18, 0, 0)))
    ...
    models = {
        ...
        u'tasktracker.task': {
            ...
            'expiration_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'db_index': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
